...
> 课程方法讲义与研究实践指南  
> 编写日期：2026年9月21日  
> 基础材料：《第3讲—文本数据预处理和文本表示技术》《第4讲—新闻与舆情分析应用》《第5章—文本聚类方法分析》《第6章—文本分类方法》四份课件，共140页。

新闻与舆情数据分析研究的是：**谁在什么时间、什么平台，围绕什么对象和事件，表达了什么观点，这些表达如何传播、变化，并产生何种可观察结果。** 文本处理与机器学习提供计算工具，新闻传播理论提供问题和解释框架，人工核验与研究设计决定结论是否可信。

本讲义以四份课件中的预处理、词义消歧、文本表示、数据融合、分类、聚类、数据流和网络应用为基础，扩展主题模型、情感与立场、框架分析、动态监测、统计推断、大模型辅助研究和多模态分析。扩展内容用于连接完整研究流程，不表示原课件已逐项讲授。文中的示例均为教学构造，不对应真实事件或学生评价。
...
25. [核心概念辨析、课件对应与参考资料](#section-25)
...
课件中的Markov聚类、HyperLex等可理解为利用共现图结构诱导词义的思路。实际选用时应检查图的构建单位、边权和剪枝规则。
...
课件中的时间序列流、插入型流（cash-register）和允许增减更新的turnstile模型描述不同的数据更新语义；它们与窗口选择是不同维度。
...
课件中的凝聚子群概念还包括团、n-clique、n-clan、k-core等。团要求内部两两相连；k-core要求子图内各节点至少具有$k$个邻接节点。它们表达不同强度的结构凝聚，不应混为一个指标。
...
按照课件的专家模型，可组织公开的基本信息、研究方向、论文、专利、项目、合作关系和学术活动。研究重点是实体消歧、专业领域识别与合作结构，不必为完成分析而收集无关的私人联系信息。

同名作者消歧可以综合机构、时间、共同作者、主题和稳定标识符。合作多、发表多、网络位置重要均不自动等于某个具体问题上的可靠专业判断。

### 17.5 企业与产业关系网络

按课件思路，可以从网页提取企业名称、产业属性和共现关系，形成候选网络。进一步研究投资、供应、合作、竞争等关系时，必须抽取明确关系证据。
...
课件中的浏览、点击、发帖、回复、粉丝等指标可作为不同侧面的观测量；“价值观”“影响力”则需要额外定义和证据，不能仅由粉丝数或一次发言直接推定。
...
课件将金融风险列为应用方向。方法上，可以抽取企业事件、风险主张和信息来源，研究新闻特征与后续可观察结果的关联或预测能力。
...
以下页码按PPT文件中的幻灯片顺序计算，包括封面，不以页面内可能出现的章节编号计算。

| 课件与页码 | 原材料重点 | 本讲义对应 |
|---|---|---|
| 第3讲，第3—19页 | 文本预处理、词义冲突、消歧与相关方法 | 第3—4节 |
| 第3讲，第20—28页 | 离散表示、词袋、n-gram、TF-IDF与词向量 | 第5节 |
| 第3讲，第29—40页 | 稀疏性、平滑、维度问题与降维 | 第6节 |
| 第3讲，第41—51页 | 数据融合、实体识别、消歧与关联 | 第4、17—18节 |
| 第4讲，第3—4页 | 舆情指标体系，主体、客体与关联模型 | 第1、14、16、22节 |
| 第4讲，第5—6页 | 企业名称与产业提取、共现关系流程 | 第17、22节 |
| 第4讲，第7—9页 | 专家模型、消歧、专家网络与知识图谱 | 第4、17节 |
| 第4讲，第10—11页 | 专利地图、金融风险应用方向 | 第22节 |
| 第5章，第3—22页 | 聚类过程、数据类型、距离、相似度与要求 | 第10—11节 |
| 第5章，第23—30页 | K-means、DBSCAN、密度峰值与评价 | 第10—11节 |
| 第5章，第31—39页 | 数据流、窗口、STREAM、CluStream、演化 | 第15节 |
| 第6章，第3—11页 | 分类定义、流程、方法与评价 | 第8—9节 |
| 第6章，第12—20页 | 贝叶斯、朴素贝叶斯与贝叶斯网络 | 第8节 |
| 第6章，第21—30页 | 支持向量机、核与多分类 | 第8节 |
| 第6章，第31—35页 | Rocchio、KNN、Boosting | 第8节 |

主题模型、内容与框架、情感与立场、统计识别、大模型和多模态等章节是为完整研究链条补充的内容。课件中概念简写、公式展示及表述容易引起混淆的地方，正文按明确的任务定义重新说明。

### 25.3 基础课件

1. 《第3讲—文本数据预处理和文本表示技术》，52页。
2. 《第4讲—新闻与舆情分析应用》，12页。
3. 《第5章—文本聚类方法分析》，40页。
4. 《第6章—文本分类方法》，36页。
