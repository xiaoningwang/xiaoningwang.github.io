...
![决策树的分割过程](figure/tree.png){ width="80%" }
...
![基于Carseats数据集的回归树](figure/tree2.png){ width="60%" }
...
![分类树算法](figure/tree3.png){ width="80%" }

## 分类树算法

![分类树算法](figure/tree4.png){ width="80%" }

## 三指标关系

![关系图](figure/tree5.png){ width="80%" }
...
![回归树算法](figure/tree7.png){ width="80%" }

## 回归树结果

![回归树结果](figure/tree8.png){ width="80%" }
...
![Bagging](figure/bagging.png){ width="80%" }
...
![基于biopsy数据集的变量重要性](figure/bagging2.png){ width="60%" }
...
![随机森林算法](figure/RF.png){ width="100%" }
...
![AdaBoost](figure/ada.png){ width="100%" }
...
![GBDT](figure/gbdt.png){ width="100%" }
...
![XGBoost](figure/Xgboost.png){ width="100%" }

##

![XGBoost](figure/Xgboost2.png){ width="100%" }
